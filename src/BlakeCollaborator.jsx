      ...
      <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'dark bg-black text-white' : 'light bg-white text-black'}`}>
        ...
        <div className="max-w-5xl mx-auto px-8 lg:px-12 py-20">
          ...
          <section id="profile" className="mb-40">
            ...
            <div className="mb-20">
              <h1 className={`blake-title text-4xl sm:text-5xl md:text-7xl tracking-tight mb-8 text-white`} style={{fontFamily: 'Manrope, system-ui, sans-serif', fontWeight: 500}}>Blake Carter</h1>
            </div>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-lg font-light text-white group-hover:text-gray-200">Email</span>
                  </div>
                  <button
                    onClick={(e) => {
                      e.preventDefault();
                    ...
                    className="screen-only px-3 py-1 bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-white text-sm rounded transition-colors"
                  >
                    Copy
                  </button>
                </div>
