        ...
        <div className="max-w-5xl mx-auto px-12 sm:px-18 py-20 pt-32">
                ...
                <div className="rounded-2xl p-2 subtle-noise" style={{backgroundColor: isDarkMode ? 'transparent' : '#faf9f7'}}>
                  <div
                    ...
                    onClick={() => setModalImage({
                      ...
                      caption: {
                        title: "Hiking (around)",
                        description: "Ultimate polar bear danger",
          ...
          <div className="mb-20 text-center">
            <div className="text-sm text-gray-600 dark:text-gray-400 mb-3 font-mono">
              web and print collateral fully designed and developed by me — per hands-on ethos — since day dot
            </div>

            {/* Tech Stack Icons */}
            <div className="flex justify-center flex-wrap items-center gap-3 grayscale opacity-60">
              {/* React */}
